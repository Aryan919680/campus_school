                    ...
                    <div className="bg-gray-800 p-6 rounded-xl w-7/12 mx-auto text-white">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <select name="subjectId" value={formData.subjectId} onChange={handleChange} className="p-2 rounded-md text-black">
                                ...
                                {subjects.map(subj => (
                                    <option key={subj.subjectId} value={subj.subjectId}>{subj.subjectCode}-{subj.name}</option>
                                ))}
                            </select>
                            ...
                            {timetable.length === 0 ? (
                                ...
                                <>
                                        ...
                                        <tbody>
                                            {timetable.map((entry, idx) => (
                                                <tr key={idx} className="text-center border-t border-gray-600">
                                                    ...
                                                    <td className="p-2 border">{entry.subjectCode}-{entry.subjectName}</td>
                                    ...
                                    <button
                                        ...
                                        className={`mt-4 ${isSaved || timetable.length === 0 ? 'bg-gray-500 cursor-not-allowed' : 'bg-green-500 hover:bg-green-600'} w-full py-2 rounded-md`}
                                    >
                                        Save Timetable
                                    </button>
