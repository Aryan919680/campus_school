...
const AdminProfileView = ({ isOpen, onClose, adminData }) => {
	...
	return (
		<Modal modalOpen={isOpen} setModalOpen={onClose} responsiveWidth={"md:w-fit"}>
			<div className="flex flex-col md:flex-row gap-4 p-4">
				<div className="flex flex-col items-center">
					<img
						src={adminData.photo || defaultPhoto}
						alt={adminData.name || "Admin"}
						className="w-32 h-32 rounded-full"
					/>
					<h3 className="text-xl font-semibold mt-4">{adminData.name || "N/A"}</h3>
					<p className="text-sm text-gray-500">{adminData.role || "N/A"}</p>
				</div>
				<div className="flex flex-col gap-2">
					<ModalDetails modalTitle="Email:" modalDesc={adminData.email || "N/A"} />
					<ModalDetails modalTitle="Role:" modalDesc={adminData.role || "N/A"} />
					<ModalDetails modalTitle="Campus Name:" modalDesc={adminData.campus.name || "N/A"} />
					<ModalDetails modalTitle="Campus Type:" modalDesc={adminData.campus.type || "N/A"} />
					<ModalDetails modalTitle="Director:" modalDesc={adminData.campus.director || "N/A"} />
					<ModalDetails modalTitle="Founded Year:" modalDesc={adminData.campus.foundedYear || "N/A"} />
					<ModalDetails modalTitle="Location:" modalDesc={adminData.campus.location || "N/A"} />
					<ModalDetails modalTitle="Board:" modalDesc={adminData.campus.board || "N/A"} />
				</div>
			</div>
		</Modal>
	);
