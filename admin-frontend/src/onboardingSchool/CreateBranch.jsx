...
const CreateBranch = ({ onNext, onPrevious }) => {
    const [schoolBranchData, setSchoolBranchData] = useState({
        ...
        location: localStorage.getItem("schoolBranchLocation") || "",
    });

    const handleChange = (e) => {
        const { name, value } = e.target;
        setSchoolBranchData((prevData) => ({
            ...prevData,
            [name]: value,
        }));
    };
    ...
    const handleNext = () => {
        localStorage.setItem("schoolBranchName", schoolBranchData.branchName);
        localStorage.setItem("schoolBranchLocation", schoolBranchData.location);
        ...
        <form>
            ...
            <div className="mb-4">
                ...
                <input
                    ...
                    name="branchName"
                    type="text"
                    value={schoolBranchData.branchName}
            ...
            <div className="mb-4">
                ...
                <input
                    ...
                    name="location"
                    type="text"
                    value={schoolBranchData.location}
                    onChange={handleChange}
                    className="mt-1 block w-full border border-gray-300 rounded-md p-2"
                    required
                />
