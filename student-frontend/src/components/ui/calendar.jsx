...
import { Tooltip, TooltipTrigger, TooltipContent, TooltipProvider } from "@radix-ui/react-tooltip"; // Import Tooltip components
...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
  ...
  return (
    <DayPicker
      modifiers={{ holiday: holidays.map(holiday => holiday.date) }}
            ...
            return (
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="bg-purple-600 text-white p-2 rounded">
                    <p>{holiday.reason}</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
